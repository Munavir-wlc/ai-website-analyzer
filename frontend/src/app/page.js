  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-900 text-slate-100 selection:bg-indigo-500 selection:text-white">
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="relative overflow-hidden pt-20 pb-28 px-4 sm:px-6 lg:px-8 border-b border-slate-800">
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="flex-1 text-center lg:text-left space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 max-w-md mx-auto lg:mx-0 pt-4">
                <div className="flex items-center gap-3 text-slate-305">
            ...
            <div className="w-full max-w-lg bg-slate-900/60 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-md relative">
              <div className="absolute -inset-px bg-gradient-to-br from-indigo-500/20 to-purple-500/0 rounded-3xl -z-10" />
              <h2 className="text-2xl font-bold text-white mb-6 text-center">Configure & Start Scan</h2>
              <ScanForm />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-950">
          <div className="max-w-7xl mx-auto space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Step 1 */}
              <div className="p-6 bg-slate-900/40 border border-slate-800 rounded-2xl relative">
                <div className="absolute -top-4 left-6 flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-600 text-white font-extrabold text-sm border border-indigo-500 shadow-md">
                  1
                </div>
                <h3 className="text-lg font-bold text-white mt-2 mb-3">Input Target</h3>
              ...
              <div className="p-6 bg-slate-900/40 border border-slate-800 rounded-2xl relative">
                ...
                <h3 className="text-lg font-bold text-white mt-2 mb-3">Monitor Real-Time Scan</h3>
                <p className="text-sm text-slate-400 leading-relaxed">
              ...
              <div className="p-6 bg-slate-900/40 border border-slate-800 rounded-2xl relative">
                ...
                <h3 className="text-lg font-bold text-white mt-2 mb-3">Actionable Remediation</h3>
                <p className="text-sm text-slate-400 leading-relaxed">
